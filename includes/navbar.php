<nav class="navbar" id="navbar">
    <a href="index.php" class="logo">
        <svg width="34" height="34" viewBox="0 0 34 34" fill="none" style="flex-shrink:0"><rect width="34" height="34" rx="8" fill="url(#nlogo2)"/><defs><linearGradient id="nlogo2" x1="0" y1="0" x2="34" y2="34"><stop stop-color="#4f46e5"/><stop offset="1" stop-color="#818cf8"/></linearGradient></defs><text x="17" y="23" text-anchor="middle" font-size="18" font-weight="bold" fill="#fff" font-family="Inter">N</text></svg>
        NIBS<span>Bursary</span>
    </a>
